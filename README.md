...
###### 2.配置项描述清晰，让你在配置参数时，`等同在看dubbo官方中文文档`（需要安装spring-ide插件） (<a href="https://dubbo.gitbooks.io/dubbo-user-book" target="dubbo-user-doc-cn">dubbo中文文档点这里</a>)
...
5.克隆示例代码，开始`dubbo`之旅。 （<a href="https://gitee.com/reger/spring-boot-starter-dubbo-example" target="dubbo-example">示例项目地址</a>）
```sh
